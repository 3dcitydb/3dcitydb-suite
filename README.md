...
Latest release
--------------
The latest stable release of the 3D City Database Suite is 2022.0.0.
...
for this release is available [online](https://3dcitydb-docs.readthedocs.io/en/version-2022.0/).
